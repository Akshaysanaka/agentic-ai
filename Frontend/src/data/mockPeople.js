// Mock people data for frontend display - now synced with MongoDB Atlas
// This is used for UI components that need static data for display
// Note: AI agents now use MongoDB Atlas directly for dynamic data
...
const people = [
  ...
  mk('47','Sameer Khan','sameer.khan@iitm.ac.in','IIT Madras',['Security','Systems'],'Chennai, India'),
